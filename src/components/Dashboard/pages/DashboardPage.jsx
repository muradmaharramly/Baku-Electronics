...
const DashboardPage = () => {
  ...
  const { users, userCount } = useSelector((state) => state.user);
  ...
  const stats = [
    ...
    { title: "İstifadəçilər", icon: <FaUsers />, text: "Saytdan istifadə edən hər kəs sənin nəzarətindədir!", color: "#E91E63", link: "/administrative/users" },
  ];
  ...
  const pieData = [
    ...
    { name: "İstifadəçilər", value: userCount, color: "rgb(114, 67, 254)" },
  ];
